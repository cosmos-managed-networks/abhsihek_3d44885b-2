...
#
# Examples:
# CHAIN_ID="local-1" HOME_DIR="~/.abhsihek" BLOCK_TIME="1000ms" CLEAN=true sh scripts/test_node.sh
# CHAIN_ID="local-2" HOME_DIR="~/.abhsihek" CLEAN=true RPC=36657 REST=2317 PROFF=6061 P2P=36656 GRPC=8090 GRPC_WEB=8091 ROSETTA=8081 BLOCK_TIME="500ms" sh scripts/test_node.sh
...
export HOME_DIR=$(eval echo "${HOME_DIR:-"~/.abhsihek"}")
export BINARY=${BINARY:-abhihg}
export DENOM=${DENOM:-newab}
...
from_scratch () {
  ...
  # 0x3590286b761409fde2e8dc68e23b8752c4d8c29f1efd63aw40lxf3n4mhf7dzhjkr453axur8aeln4
  ...
  # 0x3590286b761409fde2e8dc68e23b8752c4d8c29f1hj5fveer5cjtn4wd6wstzugjfdxzl0xpmf2m6u
